...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $pickupAddresses = [
            'Санкт-Петербург, Савушкина ул., 135',
            'Санкт-Петербург, Байконурская ул., 24',
            'Санкт-Петербург, Ланское шоссе, 18',
            'Санкт-Петербург, Непокоренных пр., 45',
            'Санкт-Петербург, Асафьева ул., 3',
            'Санкт-Петербург, Просвещения пр., 66',
            'Санкт-Петербург, Ланское ш., д. 18',
            'Санкт-Петербург, Гражданский пр., 112',
            'Санкт-Петербург, Кораблестроителей ул.,д.30',
            'Санкт-Петербург, 6-я Линия В.О. , 51',
            'Санкт-Петербург, Наставников пр., 3',
            'Санкт-Петербург, Солидарности пр., 9',
            'Санкт-Петербург, Российский пр. 6',
            'Санкт-Петербург, Новочеркасский пр., 45',
            'Санкт-Петербург, Матвеева пер., 5',
            'Санкт-Петербург, Марата ул., 74',
            'Санкт-Петербург, Стачек пр., 15',
            'Санкт-Петербург, Зенитчиков ул., 3',
            'Санкт-Петербург, Ленинский пр., 109',
            'Санкт-Петербург, Ветеранов пр., 128',
            'Санкт-Петербург, Звездная ул. , 9',
            'Санкт-Петербург, Караваевская ул., 23',
            'Санкт-Петербург, Седова ул., 82',
            'Санкт-Петербург, Славы пр., 53',
            'Санкт-Петербург, Дунайский пр., 29',
        ];
        $deliveryAddresses = [
