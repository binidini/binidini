...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $pickupAddresses = [
            'Ростов-на-Дону, Ворошиловский пр. 34/125',
            'Ростов-на-Дону, 40 лет Победы, дом 5',
            'Кумженская ул., 2а, Ростов-на-Дону'
        ];
        $deliveryAddresses = [
            'Будённовский просп., 97, Ростов-на-Дону',
            'ул. Суворова, 75, Ростов-на-Дону',
            'ул. Шаумяна, 96, Ростов-на-Дону',
            'пр-кт Чехова, 45Б, Ростов-на-Дону',
            'ул. Малиновского, 67, Ростов-на-Дону',
            'Красноармейская ул., 62/95, Ростов-на-Дону',
            'ул. Пушкинская, 25, Ростов-на-Дону',
            'ул. 50-Летия Ростсельмаша, 7в, Ростов-на-Дону',
            'б-р Комарова, 28Е, Ростов-на-Дону'
        ];
        $minutes = ['00', '15', '30', '45'];
