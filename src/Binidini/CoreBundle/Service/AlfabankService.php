...
class AlfabankService
{
    ...
    {
        $returnUrl = urlencode($this->router->generate('binidini_core_payment_new_success', ['order_number' => $orderNumber], true));
        $failUrl = urlencode($this->router->generate('binidini_core_payment_new_fail', ['order_number' => $orderNumber], true));
