...
class NotificationService
{
    ...
    public function notifyInsidersAboutNewDffShipping(Shipping $shipping) {
        ...
        //Азалия(Новосибирск), Цветочка(Челябинск), Buket116.ru(казань), Цветочная лавка (Нижний)
        //Вбукете.рф(Екатеринбург), Сфинкс(Новосибирск), Цветоптторг, Мосцветторг, Гиггз Райан,
        if (in_array($senderId, [125121, 125120, 125118, 125117, 125116, 125114, 124096,  124130, 2])) {
            return;
        }
